...
<x-app-layout>
    <form action="" method="post">
        ...
        <div class="w-full sm:w-2/4 lg:w-1/3 bg-slate-200 shadow-lg rounded-xl p-5 m-16 mx-auto">
            <h4 class="text-center text-lg font-semibold m-2 text-gray-500">Deposit Cash into Your Account</h4>
            ...
            <button class="w-full bg-purple-50 text-purple-400 font-semibold px-3 py-2 mt-3 rounded-md hover:ring-1 hover:ring-purple-400 focus:outline-none focus:ring-1 focus:ring-purple-400">Deposit</button>
        </div>
    </form>
    <x-footer-layout/>
</x-app-layout>