<x-app-layout>
    ...
    <form action="" method="post">
        ...
        <div class="w-full sm:w-2/4 lg:w-1/3 bg-gray-200 border border-slate-300 shadow-lg rounded-xl p-5 m-16 mx-auto">
            <h4 class="text-center text-lg font-semibold m-2 text-gray-500">Request A Loan For Yourself</h4>
            <h6 class="text-center text-xs font-semibold m-2 text-green-700 px-4 py-2 bg-green-50 rounded-full">Directly on {{ auth()->user()->account->accno }}</h6>
